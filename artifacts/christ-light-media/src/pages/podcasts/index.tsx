          ...
          {podcasts.map(show => (
            <div key={show.id} className="flex gap-5 bg-card rounded-2xl p-5 hover:bg-[#222] transition-colors cursor-pointer group relative border border-white/5 hover:border-gold/30">
              <div className="w-20 h-20 rounded-xl overflow-hidden flex-shrink-0">
                <img src={show.coverImage || "https://images.unsplash.com/photo-1507838153414-b4b713384a76?q=80&w=2070"} alt={show.title} width={80} height={80} className="object-cover" />
              </div>
              ...
              <ScrollReveal key={ep.id} delay={i * 60}>
                <div className={`flex items-center gap-5 p-5 rounded-2xl transition-all group border ${
                  ...
                  <div className="w-14 h-14 rounded-xl overflow-hidden flex-shrink-0 relative">
                    <img src={ep.coverImage || "https://images.unsplash.com/photo-1507838153414-b4b713384a76?q=80&w=2070"} alt={ep.title} width={56} height={56} className="object-cover" />
                  </div>
